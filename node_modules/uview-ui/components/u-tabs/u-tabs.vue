				...
				<view class="u-scroll-box" :class="{'u-tabs-scorll-flex': !isScroll}">
					<view class="u-tab-item u-line-1" :id="'u-tab-item-' + index" v-for="(item, index) in list" :key="index" @tap="clickTab(index)"
					 :style="[tabItemStyle(index)]">
						...
						<!-- <view v-if="item[count] || item['count'] == 0" style="position:absolute;top:50%;right:-5rpx;transform: translateY(-50%);"><span>({{item[count] || item['count']}})</span></view> -->
						{{ item[name] || item['name']}}<span  v-if="item[count] || item['count'] == 0">({{item[count] || item['count']}})</span>
					</view>
