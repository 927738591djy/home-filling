...
function populateParameters(result) {var _result$brand =
  ...
  var parameters = {
    appId: "__UNI__F9D6075",
    appName: "home-filling",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _config = _interopRequireDefault(__webpack_require__(/*! ./config.js */ 14));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  apis: {
    ...
    //登录授权
    loginAuthorization: function loginAuthorization(data) {
    ...
    // 安装提交
    installSubmit: function installSubmit(data) {
      return _config.default.post('/order/order/install_submit', data);
    },

    // 预约安装
    preInstall: function preInstall(data) {
      return _config.default.post('/install/install/pre_install', data);
    },
    ...
    // 整改订单详情
    getOrderReformDetail: function getOrderReformDetail(orderId) {
      return _config.default.get('/order/order/get_rectify_detail?orderId=' + orderId);
    },

    // 整改提交
    ReformSubmit: function ReformSubmit(data) {
      return _config.default.get('/order/order/rectify_submit', data);
    },

    //售后订单列表查询
    getAfterSaleOrderList: function getAfterSaleOrderList(orderStatus, likeKeyWords) {
      return _config.default.get('/order/order/get_after_sale_list?orderStatus=' + orderStatus + '&likeKeyWords=' +
      likeKeyWords);
    },
    // 售后订单详情
    getAfterSaleOrderDetail: function getAfterSaleOrderDetail(orderId) {
      return _config.default.get('/order/order/get_after_sale_detail?orderId=' + orderId);
    },

    // 售后提交
    AfterSaleSubmit: function AfterSaleSubmit(data) {
      return _config.default.get('/aftersale/after-sale/after_sale_submit', data);
    },

    // 结算单列表待确认
    getToConfirmSettleOrderList: function getToConfirmSettleOrderList(likeKeyWords) {
      return _config.default.get('/settle/settle/get_to_confirm_settle_list?likeKeyWords' + likeKeyWords);
    },

    // 结算单列表已结算
    getPayedSettleOrderList: function getPayedSettleOrderList(likeKeyWords) {
      return _config.default.get('/settle/settle/get_payed_settle_list?likeKeyWords=' + likeKeyWords);
    },

    // 结算订单详情
    getSettleDetail: function getSettleDetail(orderId) {
      return _config.default.get('/settle/settle/get_settle_detail?id=' + orderId);
    },

    // 库存列表
    getAssetsOrderList: function getAssetsOrderList(likeKeyWords) {
      return _config.default.get('/asset/asset/get_asset_list?likeKeyWords' + likeKeyWords);
...
var lsxmRequest = new _request.default();
var timers;
var reson = true;
// 请求拦截器
lsxmRequest.interceptors.request(function (request) {
...
// 响应拦截器
lsxmRequest.interceptors.response(function (response) {
  // 在拿到数据后
  // clearTimeout()
  uni.hideLoading();
  // 超时重新登录
...
// 设置默认配置
lsxmRequest.setConfig(function (config) {
  ...
  var url =  true ? 'http://106.15.52.75:80/api' : undefined;
...
console.log(lsxmRequest);var _default =
lsxmRequest;exports.default = _default;
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/@dcloudio/uni-mp-weixin/dist/index.js */ 1)["default"]))
